...
Write-Host ""
Write-Host "Crea pestañas: extras, ingredientes + columnas Grupo extras / Quitar / Ingredientes / Agotado en productos"
Write-Host "Ingredientes (en productos): por burger, separados con coma — ej. Cebolla, Cheddar, Lechuga"
Write-Host "Agotado (en productos): si = visible pero sin stock; vacio = vendible (distinto de Ocultar)"
Write-Host ""
