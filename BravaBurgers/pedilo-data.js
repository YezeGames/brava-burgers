...
(function (global) {
	...
	function injectThemeCss() {
		...
		var bgDesktop = t.imagenFondoDesktop || t.imagenFondoPc || 'brava-fondo-tienda-desktop.jpg?v=8';
		var bgMobile = t.imagenFondo || 'brava-fondo-tienda-mobile.jpg?v=6';
		var bgMobileFill = 'brava-fondo-tienda-mobile-fill.jpg?v=6';
		document.documentElement.style.setProperty('--brava-bg-mobile', "url('" + bgMobile + "')");
		document.documentElement.style.setProperty('--brava-bg-mobile-fill', "url('" + bgMobileFill + "')");
